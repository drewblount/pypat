...
import DATParser_new, Patent

from pymongo import MongoClient

fnLog = 'new_patents.log'
...
if not 'patns' in dir():	# assume this is first time running
	...
	datfilelist = [DATParser_new.fr + x for x in os.listdir(DATParser_new.fr) if x[-4:] == '.dat']
else:
